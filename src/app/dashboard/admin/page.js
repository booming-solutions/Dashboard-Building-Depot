/* ============================================================
   BESTAND: page.js (Data Upload)
   KOPIEER NAAR: src/app/dashboard/admin/page.js
   
   Dit is de originele Data Upload pagina, herstelt nadat
   het per ongeluk overschreven was met de Gebruikersbeheer code.
   
   Voor Compass Excel-exports → Supabase upload.
   ============================================================ */
'use client';
